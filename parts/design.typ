...
Можно попытаться уменьшить количество некорректных трасс. Трассы могут повторяться между собой, и если считать количество таких повторений для каждой трассы, мы получим определенной частотное распределение. Чтобы исключить погрешности, можно воспользоваться фильтрацией по абсолютному или относительному порогу.
